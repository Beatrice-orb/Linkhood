...
export const INITIAL_ANNOUNCEMENTS: Announcement[] = [
  {
    id: 'ann-1',
    title: '【重要】关于西红门镇演示社区7月13日停水检修的通知',
    content: '各位居民：因自来水管网年度维护，演示社区1号楼、2号楼将于2026年7月13日09:00至17:00停水检修。请提前做好储水准备，并关闭家中水龙头。该通知为产品演示素材。',
    category: '停水停电',
    isScheduled: false,
...
export const INITIAL_HOTLINES: Hotline[] = [
  ...
  { id: 'hot-2', name: '演示社区物业服务热线', phone: '010-88889999', category: '物业管理' },
